"""
Django settings for ayoba project.
...
SECRET_KEY = 'django-insecure-@+w(dpl^zl(wj@y#n5^l8_lk%vtj4+_j(3_=m%z_ztsvq!gj4)'
...
WSGI_APPLICATION = 'ayoba.wsgi.application'
